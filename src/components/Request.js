           ...
           return (
            <div className="request-wrapper">
                ...
                <div className="action">
                    { type && type == 'raisedFor' && 
                        <button className="btn btn-approve" onClick = {()=> changeStatusReq(item.reqId)}>Approve </button>
                    }
                    { type && type == 'raisedBy' && 
                        <button className="btn btn-edit" onClick = {()=>editReq(item.reqId)}>Edit </button>
                    }
                    
                    <button className="btn btn-action" onClick = {()=>deleteReq(item.reqId)}>Delete </button>
                </div>
            </div>
           )
        });
