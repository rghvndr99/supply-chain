...
const Tile = props => {
  const { loginAssupplier, removeFromlist, product, editProduct } = props;
    ...
    <div className="card">
        ...
        <div className="container">
          ...
          <div className="more-info">
            <span className="supplied-by">
              Supplier:
              <span className="legend">{SupplierName}</span>
            </span>
            <span className="quantity">
              {" "}
              quantity:
              <span className="legend">{Quantity}</span>
            </span>
          </div>
        </div>
      </div>
      <div className="user-action">
        <button
          ...
          onClick={() => removeFromlist(ProductId)}
        >
          Remove
        </button>
